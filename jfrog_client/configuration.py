...
conf = jfrog_client.Configuration(
    username='the-user',
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://myserver.jfrog.io" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("jfrog_client")
        ...
        return [
            {
                ...
                'variables': {
                    'server_url': {
                        ...
                        'default_value': "https://myserver.jfrog.io",
                        }
                    }
            }
        ]
