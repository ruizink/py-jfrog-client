...
class ReportsNamedScopeWithPatterns(BaseModel):
    """
    ReportsNamedScopeWithPatterns
    """ # noqa: E501
    names: Optional[List[StrictStr]] = None
    include_patterns: Optional[List[StrictStr]] = None
    exclude_patterns: Optional[List[StrictStr]] = None
    number_of_latest_versions: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["names", "include_patterns", "exclude_patterns", "number_of_latest_versions"]
