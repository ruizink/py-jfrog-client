...
class GetProjectUsers200Response(BaseModel):
    """
    GetProjectUsers200Response
    """ # noqa: E501
    members: Optional[List[ProjectUser]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "members": [ProjectUser.from_dict(_item) for _item in obj["members"]] if obj.get("members") is not None else None
        })
        return _obj
