...
class SetBasicAuthenticationStatusRequest(BaseModel):
    """
    SetBasicAuthenticationStatusRequest
    """ # noqa: E501
    enabled: StrictBool = Field(description="Set to true to enable or false to disable basic authentication")
