...
class UpdateUserGroupsRequest(BaseModel):
    ...
    """ # noqa: E501
    add: Optional[List[StrictStr]] = Field(default=None, description="Groups to add the user to")
    remove: Optional[List[StrictStr]] = Field(default=None, description="Groups to remove the user from")
