...
class HealthCheckResponseServicesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["service_id", "node_id", "state", "message"]
    ...
    def state_validate_enum(cls, value):
        ...
        if value not in set(['HEALTHY', 'UNHEALTHY', 'UNHEALTHY_PEER']):
            raise ValueError("must be one of enum values ('HEALTHY', 'UNHEALTHY', 'UNHEALTHY_PEER')")
        return value
