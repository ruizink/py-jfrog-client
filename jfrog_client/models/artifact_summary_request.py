...
class ArtifactSummaryRequest(BaseModel):
    ...
    """ # noqa: E501
    paths: Optional[List[StrictStr]] = Field(default=None, description="Array of artifact paths. The path must start with the artifactory_id (default for Xray 3.x). ")
    checksums: Optional[List[StrictStr]] = Field(default=None, description="Array of SHA-256 or SHA-1 checksums. Ignored if paths is provided.")
    __properties: ClassVar[List[str]] = ["paths", "checksums"]
