...
class CheckIfRepositoryExists200Response(BaseModel):
    """
    CheckIfRepositoryExists200Response
    """ # noqa: E501
    exists: Optional[StrictBool] = None
    matching_repo_types: Optional[List[StrictStr]] = Field(default=None, alias="matchingRepoTypes")
    project_key: Optional[StrictStr] = Field(default=None, alias="projectKey")
    __properties: ClassVar[List[str]] = ["exists", "matchingRepoTypes", "projectKey"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "matchingRepoTypes": obj.get("matchingRepoTypes"),
