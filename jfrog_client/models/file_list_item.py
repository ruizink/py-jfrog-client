...
class FileListItem(BaseModel):
    ...
    size: Optional[StrictStr] = Field(default=None, description="Size in bytes, or \"-1\" for folders")
    ...
    md_timestamps: Optional[Dict[str, datetime]] = Field(default=None, alias="mdTimestamps")
    __properties: ClassVar[List[str]] = ["uri", "size", "lastModified", "folder", "sha1", "mdTimestamps"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sha1": obj.get("sha1"),
            "mdTimestamps": obj.get("mdTimestamps")
        })
        return _obj
