...
class PolicyCvssRange(BaseModel):
    """
    CVSS score range for filtering vulnerabilities.
    """ # noqa: E501
    var_from: Optional[StrictStr] = Field(default=None, description="Start of CVSS score range (0.0 - 10.0).", alias="from")
    to: Optional[StrictStr] = Field(default=None, description="End of CVSS score range (0.0 - 10.0).")
