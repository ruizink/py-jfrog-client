...
class GetArtifactoryVersion200Response(BaseModel):
    """
    GetArtifactoryVersion200Response
    """ # noqa: E501
    version: Optional[StrictStr] = Field(default=None, description="Artifactory version")
    revision: Optional[StrictStr] = Field(default=None, description="Revision number")
    addons: Optional[List[StrictStr]] = Field(default=None, description="List of addons")
    __properties: ClassVar[List[str]] = ["version", "revision", "addons"]
