...
class ScanArtifactForExposuresRequestCategories(BaseModel):
    """
    ...
    """ # noqa: E501
    secrets: Optional[StrictBool] = None
    services: Optional[StrictBool] = None
    applications: Optional[StrictBool] = None
    iac: Optional[StrictBool] = None
