...
class GlobalRoleUpdate(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="Role name; typically matches the `{role}` path parameter.")
    description: Optional[StrictStr] = None
    type: GlobalRoleType
    environments: Optional[List[StrictStr]] = None
    actions: Optional[List[StrictStr]] = Field(default=None, description="Permission actions as enum constant names (e.g. READ_REPOSITORY, MANAGE_MEMBERS).")
    __properties: ClassVar[List[str]] = ["name", "description", "type", "environments", "actions"]
