...
class PolicyAssignToWatchesResponseResult(BaseModel):
    """
    Map of watch name to assignment status string. 
    """ # noqa: E501
    watch_name: Optional[StrictStr] = Field(default=None, description="Status message for the watch. Key is the watch name. ", alias="{watch_name}")
    __properties: ClassVar[List[str]] = ["{watch_name}"]
