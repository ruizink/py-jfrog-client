...
class GetLiveLogsConfig200Response(BaseModel):
    """
    GetLiveLogsConfig200Response
    """ # noqa: E501
    logs: Optional[List[Dict[str, Any]]] = None
    nodes: Optional[List[Dict[str, Any]]] = None
    refresh_rate_millis: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["logs", "nodes", "refresh_rate_millis"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "logs": obj.get("logs"),
            "nodes": obj.get("nodes"),
            "refresh_rate_millis": obj.get("refresh_rate_millis")
        })
        return _obj
