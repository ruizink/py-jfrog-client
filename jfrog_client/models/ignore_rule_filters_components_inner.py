...
class IgnoreRuleFiltersComponentsInner(BaseModel):
    """
    IgnoreRuleFiltersComponentsInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Component identifier (e.g., docker://alpine, npm://lodash).")
    version: Optional[StrictStr] = Field(default=None, description="Component version. Omit to match all versions.")
