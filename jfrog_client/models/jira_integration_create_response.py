...
class JiraIntegrationCreateResponse(BaseModel):
    """
    Create/update success or error wrapper (PDF).
    """ # noqa: E501
    info: Optional[StrictStr] = Field(default=None, description="Present on success.")
    error: Optional[StrictStr] = Field(default=None, description="Present on failure responses.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["info", "error"]
