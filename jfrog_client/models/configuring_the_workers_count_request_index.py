...
class ConfiguringTheWorkersCountRequestIndex(BaseModel):
    """
    ConfiguringTheWorkersCountRequestIndex
    """ # noqa: E501
    new_content: Optional[StrictInt] = Field(default=None, description="Number of workers for indexing new content.")
    existing_content: Optional[StrictInt] = Field(default=None, description="Number of workers for indexing existing content.")
