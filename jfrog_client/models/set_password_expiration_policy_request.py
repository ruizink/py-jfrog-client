...
class SetPasswordExpirationPolicyRequest(BaseModel):
    """
    SetPasswordExpirationPolicyRequest
    """ # noqa: E501
    enabled: Optional[StrictStr] = None
    password_max_age: Optional[StrictStr] = Field(default=None, description="Password max age (1-999)", alias="passwordMaxAge")
    notify_by_email: Optional[StrictStr] = Field(default=None, alias="notifyByEmail")
    __properties: ClassVar[List[str]] = ["enabled", "passwordMaxAge", "notifyByEmail"]
    ...
    @field_validator('notify_by_email')
    def notify_by_email_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "passwordMaxAge": obj.get("passwordMaxAge"),
            "notifyByEmail": obj.get("notifyByEmail")
        })
        return _obj
