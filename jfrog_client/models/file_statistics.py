...
class FileStatistics(BaseModel):
    ...
    last_downloaded: Optional[StrictInt] = Field(default=None, description="Timestamp in milliseconds", alias="lastDownloaded")
    download_count: Optional[StrictInt] = Field(default=None, alias="downloadCount")
    last_downloaded_by: Optional[StrictStr] = Field(default=None, alias="lastDownloadedBy")
    __properties: ClassVar[List[str]] = ["uri", "lastDownloaded", "downloadCount", "lastDownloadedBy"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lastDownloadedBy": obj.get("lastDownloadedBy")
        })
        return _obj
