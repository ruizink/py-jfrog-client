...
class SetDistributionPublicGpgKeyRequest(BaseModel):
    """
    SetDistributionPublicGpgKeyRequest
    """ # noqa: E501
    alias: StrictStr = Field(description="The alias for the key")
    public_key: StrictStr = Field(description="The GPG public key in PGP format")
    __properties: ClassVar[List[str]] = ["alias", "public_key"]
