...
class PolicyAssignToWatchesRequest(BaseModel):
    """
    Request body containing the list of watch names to assign the policy to. 
    """ # noqa: E501
    watches: List[StrictStr] = Field(description="List of watch names to assign the policy to. Each watch is processed independently. ")
