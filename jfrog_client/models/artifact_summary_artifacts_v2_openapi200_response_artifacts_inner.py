...
class ArtifactSummaryArtifactsV2Openapi200ResponseArtifactsInner(BaseModel):
    """
    ...
    issues: Optional[List[ArtifactSummaryArtifactsV2Openapi200ResponseArtifactsInnerIssuesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "issues": [ArtifactSummaryArtifactsV2Openapi200ResponseArtifactsInnerIssuesInner.from_dict(_item) for _item in obj["issues"]] if obj.get("issues") is not None else None,
