...
class ContextualAnalysisScanRequest(BaseModel):
    """
    Start Contextual Analysis scan (PDF §12.37).
    """ # noqa: E501
    component_id: StrictStr = Field(description="Artifact component id (e.g. gav://, npm://).")
    path: StrictStr = Field(description="Artifact path in the repository.")
    repo: StrictStr = Field(description="Repository name (included in PDF sample alongside path).")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["component_id", "path", "repo"]
