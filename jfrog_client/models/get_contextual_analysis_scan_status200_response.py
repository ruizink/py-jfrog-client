...
class GetContextualAnalysisScanStatus200Response(BaseModel):
    """
    GetContextualAnalysisScanStatus200Response
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="Current scan status (e.g. not_scanned, in_progress, completed).")
