...
class GetBuildsScanResults200ResponseVulnerabilitiesInnerCvesInner(BaseModel):
    """
    GetBuildsScanResults200ResponseVulnerabilitiesInnerCvesInner
    """ # noqa: E501
    cve: Optional[StrictStr] = None
    cvss_v3_score: Optional[StrictStr] = None
    cvss_v3_vector: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["cve", "cvss_v3_score", "cvss_v3_vector"]
