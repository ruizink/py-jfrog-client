...
class GetAllThePackagesByWatchName200ResponseInner(BaseModel):
    """
    GetAllThePackagesByWatchName200ResponseInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Package name.")
    version: Optional[StrictStr] = Field(default=None, description="Package version.")
    type: Optional[StrictStr] = Field(default=None, description="Package type (e.g., npm, maven).")
    __properties: ClassVar[List[str]] = ["name", "version", "type"]
