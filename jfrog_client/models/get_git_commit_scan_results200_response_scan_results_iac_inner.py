...
class GetGitCommitScanResults200ResponseScanResultsIacInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["jfrog_severity", "id", "file", "start_line", "abbreviation", "description"]
