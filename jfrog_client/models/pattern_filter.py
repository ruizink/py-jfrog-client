...
class PatternFilter(BaseModel):
    ...
    """ # noqa: E501
    include_patterns: Optional[List[StrictStr]] = Field(default=None, description="Patterns to include")
    exclude_patterns: Optional[List[StrictStr]] = Field(default=None, description="Patterns to exclude")
