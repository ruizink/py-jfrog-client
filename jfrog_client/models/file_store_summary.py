...
class FileStoreSummary(BaseModel):
    ...
    storage_directory: Optional[StrictStr] = Field(default=None, alias="storageDirectory")
    total_space: Optional[StrictStr] = Field(default=None, alias="totalSpace")
    used_space: Optional[StrictStr] = Field(default=None, alias="usedSpace")
    free_space: Optional[StrictStr] = Field(default=None, alias="freeSpace")
    __properties: ClassVar[List[str]] = ["storageType", "storageDirectory", "totalSpace", "usedSpace", "freeSpace"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "storageDirectory": obj.get("storageDirectory"),
