...
class GetConfiguredRetentionPoliciesList200Response(BaseModel):
    """
    GetConfiguredRetentionPoliciesList200Response
    """ # noqa: E501
    total: Optional[StrictInt] = None
    items: Optional[List[GetConfiguredRetentionPoliciesList200ResponseItemsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "total": obj.get("total"),
            "items": [GetConfiguredRetentionPoliciesList200ResponseItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
