...
class FederatedRepositoryFullSync200Response(BaseModel):
    """
    FederatedRepositoryFullSync200Response
    """ # noqa: E501
    message: Optional[StrictStr] = None
    result_paths: Optional[List[StrictStr]] = Field(default=None, alias="resultPaths")
    __properties: ClassVar[List[str]] = ["message", "resultPaths"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resultPaths": obj.get("resultPaths")
        })
        return _obj
