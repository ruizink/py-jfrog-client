...
class RepositoryAdvancedScansRequestFiltersDateRange(BaseModel):
    """
    Date range filter for artifact selection.
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Date filter type: artifact_deployment_date or artifact_download_date.")
    date_start: Optional[datetime] = Field(default=None, description="Start of the date range (RFC 3339).")
    date_end: Optional[datetime] = Field(default=None, description="End of the date range (RFC 3339).")
    __properties: ClassVar[List[str]] = ["type", "date_start", "date_end"]
