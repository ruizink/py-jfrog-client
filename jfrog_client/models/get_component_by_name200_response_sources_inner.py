...
class GetComponentByName200ResponseSourcesInner(BaseModel):
    """
    ...
    updated: Optional[StrictStr] = Field(default=None, description="Timestamp when the source was last updated.")
    __properties: ClassVar[List[str]] = ["name", "url", "updated"]
