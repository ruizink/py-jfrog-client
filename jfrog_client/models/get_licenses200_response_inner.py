...
class GetLicenses200ResponseInner(BaseModel):
    """
    ...
    category: StrictStr
    priority: StrictInt
    default_priority: StrictInt
    is_custom: StrictBool = Field(alias="isCustom")
    __properties: ClassVar[List[str]] = ["name", "full_name", "references", "category", "priority", "default_priority", "isCustom"]
