...
class SearchArchive200ResponseResultsInner(BaseModel):
    """
    SearchArchive200ResponseResultsInner
    """ # noqa: E501
    entry: Optional[StrictStr] = None
    archive_uris: Optional[List[StrictStr]] = Field(default=None, alias="archiveUris")
    __properties: ClassVar[List[str]] = ["entry", "archiveUris"]
