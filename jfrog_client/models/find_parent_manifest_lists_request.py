...
class FindParentManifestListsRequest(BaseModel):
    """
    FindParentManifestListsRequest
    """ # noqa: E501
    docker_repository: StrictStr = Field(description="Docker repository name", alias="dockerRepository")
    tag: StrictStr = Field(description="Docker tag")
    __properties: ClassVar[List[str]] = ["dockerRepository", "tag"]
