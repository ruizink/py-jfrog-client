...
class CustomIssuesEventMutationRequestComponentsInner(BaseModel):
    """
    CustomIssuesEventMutationRequestComponentsInner
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Component identifier.")
    vulnerable_versions: Optional[List[StrictStr]] = Field(default=None, description="List of vulnerable version ranges.")
    fixed_versions: Optional[List[StrictStr]] = Field(default=None, description="List of fixed version ranges (null if none).")
    __properties: ClassVar[List[str]] = ["id", "vulnerable_versions", "fixed_versions"]
