...
class OfflineTokenRequest(BaseModel):
    ...
    OfflineTokenRequest
    """ # noqa: E501
    offline_request_token: Optional[StrictStr] = Field(default=None, description="The offline request token obtained from the start register endpoint on the air-gapped JPD")
    __properties: ClassVar[List[str]] = ["offline_request_token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "offline_request_token": obj.get("offline_request_token")
        })
        return _obj
