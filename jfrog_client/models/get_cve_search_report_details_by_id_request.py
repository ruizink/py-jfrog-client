...
class GetCveSearchReportDetailsByIdRequest(BaseModel):
    """
    GetCveSearchReportDetailsByIdRequest
    """ # noqa: E501
    filters: Optional[GetCveSearchReportDetailsByIdRequestFilters] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filters": GetCveSearchReportDetailsByIdRequestFilters.from_dict(obj["filters"]) if obj.get("filters") is not None else None
        })
        return _obj
