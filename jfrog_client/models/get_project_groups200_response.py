...
class GetProjectGroups200Response(BaseModel):
    """
    GetProjectGroups200Response
    """ # noqa: E501
    members: Optional[List[ProjectGroup]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "members": [ProjectGroup.from_dict(_item) for _item in obj["members"]] if obj.get("members") is not None else None
        })
        return _obj
