...
class Patterns(BaseModel):
    ...
    Patterns
    """ # noqa: E501
    include_patterns: Optional[List[StrictStr]] = Field(default=None, description="Include patterns")
    exclude_patterns: Optional[List[StrictStr]] = Field(default=None, description="Exclude patterns")
