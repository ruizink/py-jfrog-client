...
class ScanArtifactRequest(BaseModel):
    ...
    ScanArtifactRequest
    """ # noqa: E501
    component_id: StrictStr = Field(description="The component ID of the artifact to scan (e.g. docker://image_name:image_tag).", alias="componentID")
    __properties: ClassVar[List[str]] = ["componentID"]
