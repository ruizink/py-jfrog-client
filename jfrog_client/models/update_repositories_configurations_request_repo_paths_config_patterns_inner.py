...
class UpdateRepositoriesConfigurationsRequestRepoPathsConfigPatternsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["include", "exclude", "index_new_artifacts", "retention_in_days"]
