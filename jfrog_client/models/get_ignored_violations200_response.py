...
class GetIgnoredViolations200Response(BaseModel):
    """
    GetIgnoredViolations200Response
    """ # noqa: E501
    violations_count: StrictInt
    violations: List[GetIgnoredViolations200ResponseViolationsInner]
    __properties: ClassVar[List[str]] = ["violations_count", "violations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "violations_count": obj.get("violations_count"),
            "violations": [GetIgnoredViolations200ResponseViolationsInner.from_dict(_item) for _item in obj["violations"]] if obj.get("violations") is not None else None
        })
        return _obj
