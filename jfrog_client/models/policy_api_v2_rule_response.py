...
class PolicyApiV2RuleResponse(BaseModel):
    """
    A rule within a policy (v2 response format).
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name of the rule.")
    priority: Optional[StrictInt] = Field(default=None, description="Priority for ordering between rules.")
    criteria: Optional[PolicyCriteria] = None
    actions: Optional[PolicyActionsV2Response] = None
    __properties: ClassVar[List[str]] = ["name", "priority", "criteria", "actions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "criteria": PolicyCriteria.from_dict(obj["criteria"]) if obj.get("criteria") is not None else None,
            "actions": PolicyActionsV2Response.from_dict(obj["actions"]) if obj.get("actions") is not None else None
        })
        return _obj
