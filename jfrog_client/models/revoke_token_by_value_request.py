...
class RevokeTokenByValueRequest(BaseModel):
    """
    RevokeTokenByValueRequest
    """ # noqa: E501
    token: StrictStr = Field(description="The token value to revoke. Can be either a reference token or a JWT access token. The token must have been created with `force_revocable: true` or `refreshable: true` for JWT tokens to be revocable.")
