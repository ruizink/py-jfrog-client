...
class JiraIntegrationStatusResponse(BaseModel):
    ...
    """ # noqa: E501
    status: StrictStr = Field(description="HEALTHY_INTEGRATION, INTEGRATION_NOT_FOUND, INTERNAL_SERVER_ERROR, FAULTY_CONFIGURATION.")
    reason: StrictStr
    time: StrictStr = Field(description="RFC 3339 timestamp.")
    integration_name: StrictStr
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["status", "reason", "time", "integration_name"]
