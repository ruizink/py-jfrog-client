...
class ListIgnoredViolations200Response(BaseModel):
    """
    ListIgnoredViolations200Response
    """ # noqa: E501
    data: Optional[List[Dict[str, Any]]] = Field(default=None, description="List of ignored violations.")
    total_count: Optional[StrictInt] = Field(default=None, description="Total count of matching ignored violations.")
