...
class ArtifactScanStatus200Response(BaseModel):
    """
    ArtifactScanStatus200Response
    """ # noqa: E501
    overall: Optional[ArtifactScanStatus200ResponseOverall] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "overall": ArtifactScanStatus200ResponseOverall.from_dict(obj["overall"]) if obj.get("overall") is not None else None,
