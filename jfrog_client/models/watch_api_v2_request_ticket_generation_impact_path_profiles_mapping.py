...
class WatchApiV2RequestTicketGenerationImpactPathProfilesMapping(BaseModel):
    """
    Mapping of impact path profiles.
    """ # noqa: E501
    include: Optional[List[WatchApiV2RequestTicketGenerationImpactPathProfilesMappingIncludeInner]] = Field(default=None, description="Impact path to Jira profile mappings.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "include": [WatchApiV2RequestTicketGenerationImpactPathProfilesMappingIncludeInner.from_dict(_item) for _item in obj["include"]] if obj.get("include") is not None else None
        })
        return _obj
