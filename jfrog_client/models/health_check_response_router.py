...
class HealthCheckResponseRouter(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["node_id", "state", "message"]
    ...
    def state_validate_enum(cls, value):
        ...
        if value not in set(['HEALTHY', 'UNHEALTHY']):
            raise ValueError("must be one of enum values ('HEALTHY', 'UNHEALTHY')")
        return value
