...
class CustomIssuesEventMutationRequestCvesInner(BaseModel):
    """
    CustomIssuesEventMutationRequestCvesInner
    """ # noqa: E501
    cve: Optional[StrictStr] = Field(default=None, description="CVE identifier.")
    cvss_v2: Optional[StrictStr] = Field(default=None, description="CVSS v2 score.")
    __properties: ClassVar[List[str]] = ["cve", "cvss_v2"]
