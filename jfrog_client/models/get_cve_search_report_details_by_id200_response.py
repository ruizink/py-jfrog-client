...
class GetCveSearchReportDetailsById200Response(BaseModel):
    """
    GetCveSearchReportDetailsById200Response
    """ # noqa: E501
    cve: StrictStr
    total_rows: StrictInt
    produced_at: StrictStr
    created_by: StrictStr
    rows: List[GetCveSearchReportDetailsById200ResponseRowsInner]
    __properties: ClassVar[List[str]] = ["cve", "total_rows", "produced_at", "created_by", "rows"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rows": [GetCveSearchReportDetailsById200ResponseRowsInner.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
        return _obj
