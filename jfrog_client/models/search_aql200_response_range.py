...
class SearchAql200ResponseRange(BaseModel):
    """
    SearchAql200ResponseRange
    """ # noqa: E501
    start_pos: Optional[StrictInt] = None
    end_pos: Optional[StrictInt] = None
    total: Optional[StrictInt] = None
    limit: Optional[StrictInt] = None
    notification: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["start_pos", "end_pos", "total", "limit", "notification"]
