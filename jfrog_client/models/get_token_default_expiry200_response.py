...
class GetTokenDefaultExpiry200Response(BaseModel):
    """
    GetTokenDefaultExpiry200Response
    """ # noqa: E501
    default_token_expiration: Optional[StrictInt] = Field(default=None, description="Default token expiration in seconds")
    __properties: ClassVar[List[str]] = ["default_token_expiration"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "default_token_expiration": obj.get("default_token_expiration")
        })
        return _obj
