...
class ReportsGenerateExposuresRequest(BaseModel):
    """
    ReportsGenerateExposuresRequest
    """ # noqa: E501
    name: StrictStr
    resources: ReportsResourcesBlock
    filters: ReportsGenerateExposuresRequestFilters
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "filters": ReportsGenerateExposuresRequestFilters.from_dict(obj["filters"]) if obj.get("filters") is not None else None
        })
        return _obj
