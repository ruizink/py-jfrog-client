...
class GetViolationsReportContent200ResponseRowsInnerCvesInner(BaseModel):
    """
    ...
    cvss_v3_score: Optional[Union[StrictFloat, StrictInt]] = None
    cvss_v3_vector: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["cvss_v2_score", "cvss_v2_vector", "cvss_v3_score", "cvss_v3_vector"]
