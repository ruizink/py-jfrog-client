...
class GetCveSearchReportsList200Response(BaseModel):
    """
    GetCveSearchReportsList200Response
    """ # noqa: E501
    total_reports: StrictInt
    reports: List[GetCveSearchReportsList200ResponseReportsInner]
    __properties: ClassVar[List[str]] = ["total_reports", "reports"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reports": [GetCveSearchReportsList200ResponseReportsInner.from_dict(_item) for _item in obj["reports"]] if obj.get("reports") is not None else None
        })
        return _obj
