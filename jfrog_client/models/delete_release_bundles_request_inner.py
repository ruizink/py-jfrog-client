...
class DeleteReleaseBundlesRequestInner(BaseModel):
    """
    DeleteReleaseBundlesRequestInner
    """ # noqa: E501
    bundle_name: StrictStr = Field(description="The bundle name")
    bundle_version: StrictStr = Field(description="The bundle version")
    __properties: ClassVar[List[str]] = ["bundle_name", "bundle_version"]
