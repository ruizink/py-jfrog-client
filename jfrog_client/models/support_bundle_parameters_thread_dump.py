...
class SupportBundleParametersThreadDump(BaseModel):
    """
    SupportBundleParametersThreadDump
    """ # noqa: E501
    count: Optional[StrictInt] = Field(default=1, description="Number of thread dumps to collect")
    interval: Optional[StrictInt] = Field(default=0, description="Interval between thread dumps in milliseconds")
