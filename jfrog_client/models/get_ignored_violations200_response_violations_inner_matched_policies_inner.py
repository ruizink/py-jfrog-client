...
class GetIgnoredViolations200ResponseViolationsInnerMatchedPoliciesInner(BaseModel):
    """
    GetIgnoredViolations200ResponseViolationsInnerMatchedPoliciesInner
    """ # noqa: E501
    policy: StrictStr
    rule: StrictStr
    is_blocking: StrictBool
    is_ignored: StrictBool
    __properties: ClassVar[List[str]] = ["policy", "rule", "is_blocking", "is_ignored"]
