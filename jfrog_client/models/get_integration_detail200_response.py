...
class GetIntegrationDetail200Response(BaseModel):
    """
    ...
    skip_proxy: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["connection_name", "auth_type", "username", "installation_type", "jira_server_url", "skip_proxy"]
