...
class ProjectRole(BaseModel):
    ...
    environments: Optional[List[StrictStr]] = Field(default=None, description="Environments for the role")
    actions: Optional[List[StrictStr]] = Field(default=None, description="Actions permitted by this role")
