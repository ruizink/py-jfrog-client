...
class ArtifactSummary200ResponseArtifactsInnerLicensesInner(BaseModel):
    """
    ArtifactSummary200ResponseArtifactsInnerLicensesInner
    """ # noqa: E501
    name: Optional[StrictStr] = None
    full_name: Optional[StrictStr] = None
    more_info_url: Optional[List[StrictStr]] = None
    components: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["name", "full_name", "more_info_url", "components"]
