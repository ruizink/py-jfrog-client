...
class CreateDebianSnapshotRequest(BaseModel):
    """
    CreateDebianSnapshotRequest
    """ # noqa: E501
    tag: StrictStr = Field(description="The snapshot tag")
    target_repo: StrictStr = Field(description="The target repository", alias="targetRepo")
    distribution: StrictStr = Field(description="The distribution name")
    __properties: ClassVar[List[str]] = ["tag", "targetRepo", "distribution"]
