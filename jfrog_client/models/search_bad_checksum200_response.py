...
class SearchBadChecksum200Response(BaseModel):
    """
    SearchBadChecksum200Response
    """ # noqa: E501
    results: Optional[List[SearchBadChecksum200ResponseResultsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [SearchBadChecksum200ResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
