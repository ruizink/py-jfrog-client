...
class SupportBundleConfig(BaseModel):
    ...
    SupportBundleConfig
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Support bundle name")
    description: Optional[StrictStr] = Field(default=None, description="Support bundle description")
