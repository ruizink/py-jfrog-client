...
class PermissionListResponse(BaseModel):
    ...
    """ # noqa: E501
    permissions: Optional[List[PermissionListResponsePermissionsInner]] = None
    cursor: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["permissions", "cursor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "permissions": [PermissionListResponsePermissionsInner.from_dict(_item) for _item in obj["permissions"]] if obj.get("permissions") is not None else None,
