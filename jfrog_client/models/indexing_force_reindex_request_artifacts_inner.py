...
class IndexingForceReindexRequestArtifactsInner(BaseModel):
    """
    IndexingForceReindexRequestArtifactsInner
    """ # noqa: E501
    repository: Optional[StrictStr] = Field(default=None, description="Repository name.")
    path: Optional[StrictStr] = Field(default=None, description="Artifact path within the repository.")
    sha256: Optional[StrictStr] = Field(default=None, description="SHA256 checksum of the artifact.")
