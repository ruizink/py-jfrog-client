...
class LicenseBucketCreate(BaseModel):
    """
    LicenseBucketCreate
    """ # noqa: E501
    name: StrictStr = Field(description="Bucket's name in Mission Control")
    url: StrictStr = Field(description="URL to download the encrypted bucket file")
    key: StrictStr = Field(description="Key used to decrypt the bucket")
    __properties: ClassVar[List[str]] = ["name", "url", "key"]
