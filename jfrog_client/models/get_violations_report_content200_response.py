...
class GetViolationsReportContent200Response(BaseModel):
    """
    ...
    rows: Optional[List[GetViolationsReportContent200ResponseRowsInner]] = Field(default=None, description="List of violation report rows.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rows": [GetViolationsReportContent200ResponseRowsInner.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
        return _obj
