...
class RepositoryAdvancedScansRequestFilters(BaseModel):
    """
    Filters to determine which artifacts to scan.
    """ # noqa: E501
    date_range: Optional[RepositoryAdvancedScansRequestFiltersDateRange] = None
    patterns: Optional[List[RepositoryAdvancedScansRequestFiltersPatternsInner]] = Field(default=None, description="Path patterns to select artifacts.")
    __properties: ClassVar[List[str]] = ["date_range", "patterns"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "date_range": RepositoryAdvancedScansRequestFiltersDateRange.from_dict(obj["date_range"]) if obj.get("date_range") is not None else None,
            "patterns": [RepositoryAdvancedScansRequestFiltersPatternsInner.from_dict(_item) for _item in obj["patterns"]] if obj.get("patterns") is not None else None
        })
        return _obj
