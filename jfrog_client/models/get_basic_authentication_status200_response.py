...
class GetBasicAuthenticationStatus200Response(BaseModel):
    """
    GetBasicAuthenticationStatus200Response
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="Whether basic authentication is enabled")
