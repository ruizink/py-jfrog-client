...
class ItemPermissions(BaseModel):
    ...
    principals: Optional[ItemPermissionsPrincipals] = None
    __properties: ClassVar[List[str]] = ["uri", "principals"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "uri": obj.get("uri"),
            "principals": ItemPermissionsPrincipals.from_dict(obj["principals"]) if obj.get("principals") is not None else None
        })
        return _obj
