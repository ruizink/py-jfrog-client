...
class HashicorpVaultMount(BaseModel):
    """
    HashicorpVaultMount
    """ # noqa: E501
    path: Optional[StrictStr] = Field(default=None, description="Mount path.")
    type: Optional[StrictStr] = Field(default=None, description="Secret engine type.")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['KV1', 'KV2']):
            raise ValueError("must be one of enum values ('KV1', 'KV2')")
        return value
