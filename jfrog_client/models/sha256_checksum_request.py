...
class Sha256ChecksumRequest(BaseModel):
    """
    Sha256ChecksumRequest
    """ # noqa: E501
    repo_key: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Repository key", alias="repoKey")
    path: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Path to the artifact or folder")
    __properties: ClassVar[List[str]] = ["repoKey", "path"]
