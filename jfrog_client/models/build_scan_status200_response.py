...
class BuildScanStatus200Response(BaseModel):
    """
    BuildScanStatus200Response
    """ # noqa: E501
    overall: Optional[ArtifactScanStatus200ResponseDetailsSca] = None
    details: Optional[BuildScanStatus200ResponseDetails] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "details": BuildScanStatus200ResponseDetails.from_dict(obj["details"]) if obj.get("details") is not None else None
        })
        return _obj
