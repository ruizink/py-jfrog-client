...
class PolicyRule(BaseModel):
    ...
    priority: Optional[StrictInt] = Field(default=None, description="Priority for ordering between rules. Lower numbers indicate higher priority. ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "actions": PolicyActions.from_dict(obj["actions"]) if obj.get("actions") is not None else None
        })
        return _obj
