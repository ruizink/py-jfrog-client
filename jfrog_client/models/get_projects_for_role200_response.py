...
class GetProjectsForRole200Response(BaseModel):
    """
    GetProjectsForRole200Response
    """ # noqa: E501
    projects: Optional[List[GetProjectsForRole200ResponseProjectsInner]] = None
    cursor: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["projects", "cursor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "projects": [GetProjectsForRole200ResponseProjectsInner.from_dict(_item) for _item in obj["projects"]] if obj.get("projects") is not None else None,
