...
class ApplyWatchOnExistingContentRequest(BaseModel):
    """
    ApplyWatchOnExistingContentRequest
    """ # noqa: E501
    watch_names: List[StrictStr] = Field(description="List of watch names to apply.")
    date_range: ApplyWatchOnExistingContentRequestDateRange
    __properties: ClassVar[List[str]] = ["watch_names", "date_range"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "date_range": ApplyWatchOnExistingContentRequestDateRange.from_dict(obj["date_range"]) if obj.get("date_range") is not None else None
        })
        return _obj
