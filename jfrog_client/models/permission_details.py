...
class PermissionDetails(BaseModel):
    ...
    PermissionDetails
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Permission name")
    resources: Optional[PermissionDetailsResources] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "resources": PermissionDetailsResources.from_dict(obj["resources"]) if obj.get("resources") is not None else None
        })
        return _obj
