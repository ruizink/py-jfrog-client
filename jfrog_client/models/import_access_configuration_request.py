...
class ImportAccessConfigurationRequest(BaseModel):
    """
    ImportAccessConfigurationRequest
    """ # noqa: E501
    saas: Optional[StrictBool] = Field(default=None, description="Whether to import in SaaS mode")
    __properties: ClassVar[List[str]] = ["saas"]
