...
class VerifyConnection400Response(BaseModel):
    """
    VerifyConnection400Response
    """ # noqa: E501
    errors: Optional[List[DeleteCertificate200Response]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "errors": [DeleteCertificate200Response.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
