...
class ReportsGenerateViolationsRequestNotify(BaseModel):
    """
    Notification settings for the report.
    """ # noqa: E501
    emails: Optional[List[StrictStr]] = Field(default=None, description="Email addresses to notify when the report completes.")
