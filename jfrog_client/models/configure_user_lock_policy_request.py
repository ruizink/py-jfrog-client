...
class ConfigureUserLockPolicyRequest(BaseModel):
    """
    ConfigureUserLockPolicyRequest
    """ # noqa: E501
    enabled: StrictBool = Field(description="Enable or disable the user lock policy")
    login_attempts: StrictInt = Field(description="The maximum number of login attempts allowed", alias="loginAttempts")
    __properties: ClassVar[List[str]] = ["enabled", "loginAttempts"]
