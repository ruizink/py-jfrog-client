...
class ArtifactScanStatus200ResponseOverall(BaseModel):
    """
    ArtifactScanStatus200ResponseOverall
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="Overall scan status. Values: NOT_SUPPORTED, NOT_SCANNED, PENDING, SCANNING, DONE, PARTIAL, FAILED.")
    time: Optional[StrictStr] = Field(default=None, description="Timestamp (RFC 3339).")
    __properties: ClassVar[List[str]] = ["status", "time"]
