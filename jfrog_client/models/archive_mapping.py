...
class ArchiveMapping(BaseModel):
    ...
    ArchiveMapping
    """ # noqa: E501
    input: Optional[StrictStr] = Field(default=None, description="Regexp pattern to search by")
    output: Optional[StrictStr] = Field(default=None, description="Optionally provide different path of the found artifacts inside the result archive, supports regexp groups tokens")
