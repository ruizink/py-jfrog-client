...
class ReportsCvssScoreRange(BaseModel):
    """
    ReportsCvssScoreRange
    """ # noqa: E501
    min_score: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Minimum CVSS score")
    max_score: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Maximum CVSS score")
    __properties: ClassVar[List[str]] = ["min_score", "max_score"]
