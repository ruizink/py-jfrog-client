...
class FindParentManifestLists200ResponseParentManifestListsInner(BaseModel):
    """
    FindParentManifestLists200ResponseParentManifestListsInner
    """ # noqa: E501
    docker_repository: Optional[StrictStr] = Field(default=None, alias="dockerRepository")
    digest: Optional[StrictStr] = None
    tags: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["dockerRepository", "digest", "tags"]
