...
class GetComponentByName200ResponseVersionsInnerFilesInner(BaseModel):
    """
    GetComponentByName200ResponseVersionsInnerFilesInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="File name.")
    sha256: Optional[StrictStr] = Field(default=None, description="SHA-256 checksum.")
    sha1: Optional[StrictStr] = Field(default=None, description="SHA-1 checksum.")
    md5: Optional[StrictStr] = Field(default=None, description="MD5 checksum.")
    __properties: ClassVar[List[str]] = ["name", "sha256", "sha1", "md5"]
