...
class Jpd(BaseModel):
    ...
    Jpd
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="JPD ID")
    name: Optional[StrictStr] = Field(default=None, description="JPD name")
    url: Optional[StrictStr] = Field(default=None, description="JPD URL")
    status: Optional[JpdStatusCode] = None
    tags: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["id", "name", "url", "status", "tags"]
