...
class GetIgnoredViolations200ResponseViolationsInnerIgnoreRuleInfo(BaseModel):
    """
    GetIgnoredViolations200ResponseViolationsInnerIgnoreRuleInfo
    """ # noqa: E501
    id: StrictStr
    ignore_rule_type: StrictStr
    author: StrictStr
    created: StrictInt
    notes: StrictStr
    is_expired: StrictBool
    __properties: ClassVar[List[str]] = ["id", "ignore_rule_type", "author", "created", "notes", "is_expired"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "ignore_rule_type": obj.get("ignore_rule_type"),
