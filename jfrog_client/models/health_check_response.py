...
class HealthCheckResponse(BaseModel):
    ...
    HealthCheckResponse
    """ # noqa: E501
    router: Optional[HealthCheckResponseRouter] = None
    services: Optional[List[HealthCheckResponseServicesInner]] = None
    __properties: ClassVar[List[str]] = ["router", "services"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "router": HealthCheckResponseRouter.from_dict(obj["router"]) if obj.get("router") is not None else None,
            "services": [HealthCheckResponseServicesInner.from_dict(_item) for _item in obj["services"]] if obj.get("services") is not None else None
        })
        return _obj
