...
class GetProjectsForRole200ResponseProjectsInner(BaseModel):
    """
    GetProjectsForRole200ResponseProjectsInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The project display name")
    project_key: Optional[StrictStr] = Field(default=None, description="The project key", alias="projectKey")
    __properties: ClassVar[List[str]] = ["name", "projectKey"]
