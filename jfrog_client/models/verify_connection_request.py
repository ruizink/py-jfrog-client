...
class VerifyConnectionRequest(BaseModel):
    ...
    """ # noqa: E501
    endpoint: StrictStr = Field(description="The URL that Artifactory should connect to")
    username: Optional[StrictStr] = Field(default=None, description="Username to be used for the connection test (optional)")
    password: Optional[StrictStr] = Field(default=None, description="Password to be used for the connection test (optional)")
