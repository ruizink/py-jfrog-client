...
class MultipleReplicationConfigRequest(BaseModel):
    """
    MultipleReplicationConfigRequest
    """ # noqa: E501
    cron_exp: StrictStr = Field(description="Cron expression for scheduled replication", alias="cronExp")
    enable_event_replication: StrictBool = Field(description="Enable event-based replication", alias="enableEventReplication")
    replications: List[ReplicationConfigRequest]
    __properties: ClassVar[List[str]] = ["cronExp", "enableEventReplication", "replications"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "replications": [ReplicationConfigRequest.from_dict(_item) for _item in obj["replications"]] if obj.get("replications") is not None else None
        })
        return _obj
