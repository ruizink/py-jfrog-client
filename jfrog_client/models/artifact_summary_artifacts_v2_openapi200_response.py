...
class ArtifactSummaryArtifactsV2Openapi200Response(BaseModel):
    """
    ArtifactSummaryArtifactsV2Openapi200Response
    """ # noqa: E501
    artifacts: Optional[List[ArtifactSummaryArtifactsV2Openapi200ResponseArtifactsInner]] = Field(default=None, description="Array of artifact summaries.")
    errors: Optional[List[ArtifactSummary200ResponseErrorsInner]] = None
    __properties: ClassVar[List[str]] = ["artifacts", "errors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "artifacts": [ArtifactSummaryArtifactsV2Openapi200ResponseArtifactsInner.from_dict(_item) for _item in obj["artifacts"]] if obj.get("artifacts") is not None else None,
            "errors": [ArtifactSummary200ResponseErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
