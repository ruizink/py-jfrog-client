...
class ArtifactsCompareArtifactsRequest(BaseModel):
    """
    Two artifact paths to diff (see Get Artifact Delta in Xray documentation).
    """ # noqa: E501
    source_artifact_path: StrictStr = Field(description="Path of the source artifact")
    target_artifact_path: StrictStr = Field(description="Path of the target artifact")
    __properties: ClassVar[List[str]] = ["source_artifact_path", "target_artifact_path"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "source_artifact_path": obj.get("source_artifact_path"),
            "target_artifact_path": obj.get("target_artifact_path")
        })
        return _obj
