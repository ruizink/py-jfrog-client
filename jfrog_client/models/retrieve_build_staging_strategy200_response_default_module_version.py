...
class RetrieveBuildStagingStrategy200ResponseDefaultModuleVersion(BaseModel):
    """
    ...
    next_release: Optional[StrictStr] = Field(default=None, alias="nextRelease")
    next_development: Optional[StrictStr] = Field(default=None, alias="nextDevelopment")
    __properties: ClassVar[List[str]] = ["moduleId", "nextRelease", "nextDevelopment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "nextRelease": obj.get("nextRelease"),
            "nextDevelopment": obj.get("nextDevelopment")
        })
        return _obj
