...
class ProjectRoleUpdate(BaseModel):
    ...
    ProjectRoleUpdate
    """ # noqa: E501
    type: StrictStr = Field(description="Role type. Must be 'CUSTOM' for project-specific roles. Only custom roles can be updated.")
    description: Optional[StrictStr] = None
    environments: Optional[List[StrictStr]] = None
    actions: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["type", "description", "environments", "actions"]
