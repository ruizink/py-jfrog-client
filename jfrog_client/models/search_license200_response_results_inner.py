...
class SearchLicense200ResponseResultsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["uri", "license", "found", "status"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['approved', 'unapproved', 'neutral', 'unknown']):
            raise ValueError("must be one of enum values ('approved', 'unapproved', 'neutral', 'unknown')")
        return value
