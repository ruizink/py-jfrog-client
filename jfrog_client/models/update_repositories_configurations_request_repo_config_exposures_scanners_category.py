...
class UpdateRepositoriesConfigurationsRequestRepoConfigExposuresScannersCategory(BaseModel):
    """
    UpdateRepositoriesConfigurationsRequestRepoConfigExposuresScannersCategory
    """ # noqa: E501
    services_scan: Optional[StrictBool] = None
    secrets_scan: Optional[StrictBool] = None
    applications_scan: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["services_scan", "secrets_scan", "applications_scan"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "services_scan": obj.get("services_scan"),
            "secrets_scan": obj.get("secrets_scan"),
            "applications_scan": obj.get("applications_scan")
        })
        return _obj
