...
class UpdateGroupMembersRequest(BaseModel):
    ...
    """ # noqa: E501
    add: Optional[List[StrictStr]] = Field(default=None, description="Members to add")
    remove: Optional[List[StrictStr]] = Field(default=None, description="Members to remove")
