...
class DeleteDirectoryTrashPropertyResponse(BaseModel):
    """
    DeleteDirectoryTrashPropertyResponse
    """ # noqa: E501
    info: Optional[StrictStr] = Field(default=None, description="Information message about the submitted task")
