...
class GetGitCommitScanResults200ResponseScanResultsCvesInnerComponentsInner(BaseModel):
    """
    GetGitCommitScanResults200ResponseScanResultsCvesInnerComponentsInner
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Component identifier (e.g., pypi://werkzeug:1.0.1).")
    type: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    version: Optional[StrictStr] = None
    fixed_versions: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["id", "type", "name", "version", "fixed_versions"]
