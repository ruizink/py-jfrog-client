...
class RepositoryAdvancedScans200Response(BaseModel):
    """
    RepositoryAdvancedScans200Response
    """ # noqa: E501
    info: Optional[StrictStr] = Field(default=None, description="Status message.")
    scan_id: Optional[StrictInt] = Field(default=None, description="Unique scan identifier for tracking progress.")
    __properties: ClassVar[List[str]] = ["info", "scan_id"]
