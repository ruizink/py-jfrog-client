...
class PermissionResourceUpdate(BaseModel):
    """
    PermissionResourceUpdate
    """ # noqa: E501
    actions: Optional[Actions] = None
    targets: Optional[Dict[str, Patterns]] = Field(default=None, description="Map of target names to their include/exclude patterns")
    __properties: ClassVar[List[str]] = ["actions", "targets"]
