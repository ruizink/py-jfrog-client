...
class ReleaseBundleV2ScanStatus200Response(BaseModel):
    """
    ReleaseBundleV2ScanStatus200Response
    """ # noqa: E501
    overall: Optional[ArtifactScanStatus200ResponseDetailsSca] = None
    details: Optional[ArtifactScanStatus200ResponseDetails] = None
    __properties: ClassVar[List[str]] = ["overall", "details"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "overall": ArtifactScanStatus200ResponseDetailsSca.from_dict(obj["overall"]) if obj.get("overall") is not None else None,
            "details": ArtifactScanStatus200ResponseDetails.from_dict(obj["details"]) if obj.get("details") is not None else None
        })
        return _obj
