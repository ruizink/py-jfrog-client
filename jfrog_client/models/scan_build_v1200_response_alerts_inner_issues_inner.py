...
class ScanBuildV1200ResponseAlertsInnerIssuesInner(BaseModel):
    """
    ScanBuildV1200ResponseAlertsInnerIssuesInner
    """ # noqa: E501
    severity: Optional[StrictStr] = None
    type: Optional[StrictStr] = Field(default=None, description="Issue type: Security, License, or Operational_Risk.")
    provider: Optional[StrictStr] = None
    created: Optional[StrictStr] = None
    summary: Optional[StrictStr] = None
    description: Optional[StrictStr] = None
    cve: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["severity", "type", "provider", "created", "summary", "description", "cve"]
