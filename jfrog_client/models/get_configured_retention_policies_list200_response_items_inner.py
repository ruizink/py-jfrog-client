...
class GetConfiguredRetentionPoliciesList200ResponseItemsInner(BaseModel):
    """
    ...
    creation_time: Optional[StrictInt] = None
    distribution_time: Optional[StrictInt] = None
    keep: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["bundle_name", "bundle_version", "creation_time", "distribution_time", "keep"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "distribution_time": obj.get("distribution_time"),
            "keep": obj.get("keep")
        })
        return _obj
