...
class GetAllAccessFederations200Response(BaseModel):
    """
    GetAllAccessFederations200Response
    """ # noqa: E501
    targets: Optional[List[FederationTarget]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "targets": [FederationTarget.from_dict(_item) for _item in obj["targets"]] if obj.get("targets") is not None else None
        })
        return _obj
