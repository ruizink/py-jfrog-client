...
class AccessFederationListItem(BaseModel):
    """
    ...
    """ # noqa: E501
    source: Optional[StrictStr] = Field(default=None, description="Source JPD id or display name")
    error: Optional[StrictStr] = Field(default=None, description="Error message when the configuration could not be retrieved from this JPD")
    entities: Optional[List[AccessFederationEntityType]] = None
    targets: Optional[List[AccessFederationTarget]] = None
    __properties: ClassVar[List[str]] = ["source", "error", "entities", "targets"]
