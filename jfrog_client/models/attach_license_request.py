...
class AttachLicenseRequest(BaseModel):
    """
    AttachLicenseRequest
    """ # noqa: E501
    jpd_id: StrictStr = Field(description="The ID of the JPD to attach the license to")
    license_count: StrictInt = Field(description="Number of licenses to upload to Artifactory")
    __properties: ClassVar[List[str]] = ["jpd_id", "license_count"]
