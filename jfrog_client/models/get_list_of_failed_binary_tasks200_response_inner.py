...
class GetListOfFailedBinaryTasks200ResponseInner(BaseModel):
    """
    ...
    failures_count: Optional[StrictInt] = Field(default=None, alias="failuresCount")
    __properties: ClassVar[List[str]] = ["sha1", "repoKey", "creationTime", "failuresCount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "failuresCount": obj.get("failuresCount")
        })
        return _obj
