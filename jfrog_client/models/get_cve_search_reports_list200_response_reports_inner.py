...
class GetCveSearchReportsList200ResponseReportsInner(BaseModel):
    """
    ...
    name: StrictStr
    status: StrictStr
    total_artifacts: StrictInt
    num_of_processed_artifacts: StrictInt
    progress: StrictInt
    number_of_rows: StrictInt
    start_time: StrictStr
    end_time: StrictStr
    author: StrictStr
    __properties: ClassVar[List[str]] = ["id", "cve", "name", "status", "total_artifacts", "num_of_processed_artifacts", "progress", "number_of_rows", "start_time", "end_time", "author"]
