...
class GetExposureResultList200Response(BaseModel):
    """
    GetExposureResultList200Response
    """ # noqa: E501
    data: Optional[List[GetExposureResultList200ResponseDataInner]] = Field(default=None, description="List of exposure results.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [GetExposureResultList200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
