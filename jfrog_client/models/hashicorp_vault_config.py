...
class HashicorpVaultConfig(BaseModel):
    ...
    """ # noqa: E501
    auth: Optional[HashicorpVaultConfigAuth] = None
    url: Optional[StrictStr] = Field(default=None, description="Vault server URL.")
    mounts: Optional[List[HashicorpVaultMount]] = Field(default=None, description="Secret engine mounts.")
    __properties: ClassVar[List[str]] = ["auth", "url", "mounts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "auth": HashicorpVaultConfigAuth.from_dict(obj["auth"]) if obj.get("auth") is not None else None,
            "url": obj.get("url"),
            "mounts": [HashicorpVaultMount.from_dict(_item) for _item in obj["mounts"]] if obj.get("mounts") is not None else None
        })
        return _obj
