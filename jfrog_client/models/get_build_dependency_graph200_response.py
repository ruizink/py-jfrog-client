...
class GetBuildDependencyGraph200Response(BaseModel):
    """
    GetBuildDependencyGraph200Response
    """ # noqa: E501
    build: GetBuildDependencyGraph200ResponseBuild
    components: List[GetBuildDependencyGraph200ResponseComponentsInner]
    __properties: ClassVar[List[str]] = ["build", "components"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "build": GetBuildDependencyGraph200ResponseBuild.from_dict(obj["build"]) if obj.get("build") is not None else None,
            "components": [GetBuildDependencyGraph200ResponseComponentsInner.from_dict(_item) for _item in obj["components"]] if obj.get("components") is not None else None
        })
        return _obj
