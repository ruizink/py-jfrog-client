...
class SearchAql200Response(BaseModel):
    """
    SearchAql200Response
    """ # noqa: E501
    results: Optional[List[Dict[str, Any]]] = None
    range: Optional[SearchAql200ResponseRange] = None
    __properties: ClassVar[List[str]] = ["results", "range"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "range": SearchAql200ResponseRange.from_dict(obj["range"]) if obj.get("range") is not None else None
        })
        return _obj
