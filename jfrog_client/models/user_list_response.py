...
class UserListResponse(BaseModel):
    ...
    UserListResponse
    """ # noqa: E501
    users: Optional[List[UserListResponseUsersInner]] = None
    cursor: Optional[StrictStr] = Field(default=None, description="Pagination cursor")
    __properties: ClassVar[List[str]] = ["users", "cursor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "users": [UserListResponseUsersInner.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None,
