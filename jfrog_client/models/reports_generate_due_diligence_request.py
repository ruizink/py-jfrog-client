...
class ReportsGenerateDueDiligenceRequest(BaseModel):
    """
    ...
    filters: Optional[ReportsGenerateDueDiligenceRequestFilters] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "filters": ReportsGenerateDueDiligenceRequestFilters.from_dict(obj["filters"]) if obj.get("filters") is not None else None
        })
        return _obj
