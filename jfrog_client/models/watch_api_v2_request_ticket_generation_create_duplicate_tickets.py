...
class WatchApiV2RequestTicketGenerationCreateDuplicateTickets(BaseModel):
    """
    Settings for creating duplicate tickets.
    """ # noqa: E501
    by_version: Optional[WatchApiV2RequestTicketGenerationCreateDuplicateTicketsByVersion] = None
    __properties: ClassVar[List[str]] = ["by_version"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of by_version
        if self.by_version:
            _dict['by_version'] = self.by_version.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "by_version": WatchApiV2RequestTicketGenerationCreateDuplicateTicketsByVersion.from_dict(obj["by_version"]) if obj.get("by_version") is not None else None
        })
        return _obj
