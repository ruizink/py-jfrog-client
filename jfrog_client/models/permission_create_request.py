...
class PermissionCreateRequest(BaseModel):
    ...
    description: Optional[StrictStr] = Field(default=None, description="Permission description")
    resources: Optional[PermissionCreateRequestResources] = None
    __properties: ClassVar[List[str]] = ["name", "description", "resources"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resources": PermissionCreateRequestResources.from_dict(obj["resources"]) if obj.get("resources") is not None else None
        })
        return _obj
