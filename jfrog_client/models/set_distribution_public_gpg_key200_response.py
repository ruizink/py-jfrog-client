...
class SetDistributionPublicGpgKey200Response(BaseModel):
    """
    ...
    issued_by: Optional[StrictStr] = None
    valid_until: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["kid", "fingerprint", "key", "issued_on", "issued_by", "valid_until"]
