...
class GetIgnoreRules200Response(BaseModel):
    """
    GetIgnoreRules200Response
    """ # noqa: E501
    data: Optional[List[IgnoreRuleApiResponse]] = None
    total_count: Optional[StrictInt] = Field(default=None, description="Total number of matching ignore rules.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [IgnoreRuleApiResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
