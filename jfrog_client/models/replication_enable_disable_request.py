...
class ReplicationEnableDisableRequest(BaseModel):
    """
    ReplicationEnableDisableRequest
    """ # noqa: E501
    include: Optional[List[StrictStr]] = Field(default=None, description="Include patterns (target repository URLs)")
    exclude: Optional[List[StrictStr]] = Field(default=None, description="Exclude patterns (target repository URLs)")
