...
class RepositoryAdvancedScansRequestExposures(BaseModel):
    """
    Exposures scan configuration.
    """ # noqa: E501
    categories: Optional[RepositoryAdvancedScansRequestExposuresCategories] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "categories": RepositoryAdvancedScansRequestExposuresCategories.from_dict(obj["categories"]) if obj.get("categories") is not None else None
        })
        return _obj
