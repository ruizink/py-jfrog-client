...
class ScanArtifactForExposuresRequest(BaseModel):
    """
    ...
    path: StrictStr = Field(description="Artifact path in the repository.")
    categories: ScanArtifactForExposuresRequestCategories
    __properties: ClassVar[List[str]] = ["repo", "path", "categories"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "repo": obj.get("repo"),
            "path": obj.get("path"),
            "categories": ScanArtifactForExposuresRequestCategories.from_dict(obj["categories"]) if obj.get("categories") is not None else None
        })
        return _obj
