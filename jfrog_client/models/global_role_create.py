...
class GlobalRoleCreate(BaseModel):
    ...
    type: StrictStr = Field(description="Must be CUSTOM_GLOBAL. This endpoint creates custom global roles only.")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['CUSTOM_GLOBAL']):
            raise ValueError("must be one of enum values ('CUSTOM_GLOBAL')")
        return value
