...
class ScanBuildV1RequestFilters(BaseModel):
    """
    Filters for scanning options.
    """ # noqa: E501
    include_licenses: Optional[StrictBool] = Field(default=None, description="Include license information in the scan results.", alias="includeLicenses")
    __properties: ClassVar[List[str]] = ["includeLicenses"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "includeLicenses": obj.get("includeLicenses")
        })
        return _obj
