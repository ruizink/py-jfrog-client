...
class InstallLicenseRequest(BaseModel):
    ...
    """ # noqa: E501
    license_key: Optional[StrictStr] = Field(default=None, description="License key (newline characters must be represented by escape sequence \\n)", alias="licenseKey")
    __properties: ClassVar[List[str]] = ["licenseKey"]
