...
class AcquireLicenseResponse(BaseModel):
    """
    AcquireLicenseResponse
    """ # noqa: E501
    license_keys: Optional[List[StrictStr]] = Field(default=None, description="List of acquired license keys")
    __properties: ClassVar[List[str]] = ["license_keys"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "license_keys": obj.get("license_keys")
        })
        return _obj
