...
class RevokeTokenByValue200Response(BaseModel):
    """
    RevokeTokenByValue200Response
    """ # noqa: E501
    revoked_token_id: Optional[StrictStr] = Field(default=None, description="The ID of the revoked token")
    __properties: ClassVar[List[str]] = ["revoked_token_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "revoked_token_id": obj.get("revoked_token_id")
        })
        return _obj
