...
class AcquireLicenseRequest(BaseModel):
    """
    AcquireLicenseRequest
    """ # noqa: E501
    name: StrictStr = Field(description="Name to identify the acquired license")
    license_count: StrictInt = Field(description="Number of licenses to acquire from the bucket")
    __properties: ClassVar[List[str]] = ["name", "license_count"]
