...
class GetRetentionOperationsHistory200ResponseItemsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["bundle_name", "bundle_version", "operation", "created", "created_by"]
    ...
    def operation_validate_enum(cls, value):
        ...
        if value not in set(['DELETE', 'KEEP', 'UNKEEP']):
            raise ValueError("must be one of enum values ('DELETE', 'KEEP', 'UNKEEP')")
        return value
