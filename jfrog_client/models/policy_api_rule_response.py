...
class PolicyApiRuleResponse(BaseModel):
    """
    ...
    actions: Optional[PolicyApiActionsResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "actions": PolicyApiActionsResponse.from_dict(obj["actions"]) if obj.get("actions") is not None else None
        })
        return _obj
