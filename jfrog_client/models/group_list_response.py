...
class GroupListResponse(BaseModel):
    ...
    GroupListResponse
    """ # noqa: E501
    groups: Optional[List[GroupRecordResponse]] = None
    cursor: Optional[StrictStr] = Field(default=None, description="Pagination cursor")
    __properties: ClassVar[List[str]] = ["groups", "cursor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groups": [GroupRecordResponse.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None,
