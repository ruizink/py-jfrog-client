...
class ReportsReportIdStatusResponse(BaseModel):
    """
    ReportsReportIdStatusResponse
    """ # noqa: E501
    report_id: StrictInt = Field(description="New report identifier")
    status: StrictStr = Field(description="e.g. pending, running, completed")
    __properties: ClassVar[List[str]] = ["report_id", "status"]
