...
class SearchArchive200Response(BaseModel):
    """
    SearchArchive200Response
    """ # noqa: E501
    results: Optional[List[SearchArchive200ResponseResultsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [SearchArchive200ResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
