...
class ListSupportBundles200Response(BaseModel):
    """
    ListSupportBundles200Response
    """ # noqa: E501
    bundles: Optional[List[ListSupportBundles200ResponseBundlesInner]] = None
    count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["bundles", "count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bundles": [ListSupportBundles200ResponseBundlesInner.from_dict(_item) for _item in obj["bundles"]] if obj.get("bundles") is not None else None,
            "count": obj.get("count")
        })
        return _obj
