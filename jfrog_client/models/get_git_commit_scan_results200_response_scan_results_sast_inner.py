...
class GetGitCommitScanResults200ResponseScanResultsSastInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["jfrog_severity", "id", "file", "start_line", "abbreviation", "fingerprint", "description"]
