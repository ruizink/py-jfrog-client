...
class GetVersion200Response(BaseModel):
    ...
    """ # noqa: E501
    xray_version: Optional[StrictStr] = Field(default=None, description="Current Xray version.")
    xray_revision: Optional[StrictStr] = Field(default=None, description="Current Xray revision/build number.")
    __properties: ClassVar[List[str]] = ["xray_version", "xray_revision"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "xray_revision": obj.get("xray_revision")
        })
        return _obj
