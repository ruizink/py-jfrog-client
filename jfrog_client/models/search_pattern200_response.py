...
class SearchPattern200Response(BaseModel):
    """
    SearchPattern200Response
    """ # noqa: E501
    repository_uri: Optional[StrictStr] = Field(default=None, alias="repositoryUri")
    source_pattern: Optional[StrictStr] = Field(default=None, alias="sourcePattern")
    files: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["repositoryUri", "sourcePattern", "files"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sourcePattern": obj.get("sourcePattern"),
            "files": obj.get("files")
        })
        return _obj
