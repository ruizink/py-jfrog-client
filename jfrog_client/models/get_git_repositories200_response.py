...
class GetGitRepositories200Response(BaseModel):
    """
    ...
    repositories: Optional[List[GetGitRepositories200ResponseRepositoriesInner]] = None
    __properties: ClassVar[List[str]] = ["page", "limit", "total_count", "repositories"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "repositories": [GetGitRepositories200ResponseRepositoriesInner.from_dict(_item) for _item in obj["repositories"]] if obj.get("repositories") is not None else None
        })
        return _obj
