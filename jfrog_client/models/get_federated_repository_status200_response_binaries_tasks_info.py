...
class GetFederatedRepositoryStatus200ResponseBinariesTasksInfo(BaseModel):
    """
    GetFederatedRepositoryStatus200ResponseBinariesTasksInfo
    """ # noqa: E501
    in_progress_tasks: Optional[StrictInt] = Field(default=None, alias="inProgressTasks")
    failing_tasks: Optional[StrictInt] = Field(default=None, alias="failingTasks")
    __properties: ClassVar[List[str]] = ["inProgressTasks", "failingTasks"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inProgressTasks": obj.get("inProgressTasks"),
            "failingTasks": obj.get("failingTasks")
        })
        return _obj
