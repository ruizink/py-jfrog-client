...
class UpdateRepositoriesConfigurationsRequestRepoPathsConfig(BaseModel):
    """
    Path-specific configurations.
    """ # noqa: E501
    patterns: Optional[List[UpdateRepositoriesConfigurationsRequestRepoPathsConfigPatternsInner]] = Field(default=None, description="Path pattern rules.")
    all_other_artifacts: Optional[UpdateRepositoriesConfigurationsRequestRepoPathsConfigAllOtherArtifacts] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "all_other_artifacts": UpdateRepositoriesConfigurationsRequestRepoPathsConfigAllOtherArtifacts.from_dict(obj["all_other_artifacts"]) if obj.get("all_other_artifacts") is not None else None
        })
        return _obj
