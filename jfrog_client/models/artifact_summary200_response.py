...
class ArtifactSummary200Response(BaseModel):
    """
    ArtifactSummary200Response
    """ # noqa: E501
    artifacts: Optional[List[ArtifactSummary200ResponseArtifactsInner]] = Field(default=None, description="Array of artifact summaries.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "artifacts": [ArtifactSummary200ResponseArtifactsInner.from_dict(_item) for _item in obj["artifacts"]] if obj.get("artifacts") is not None else None,
