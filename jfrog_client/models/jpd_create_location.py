...
class JpdCreateLocation(BaseModel):
    """
    Geographic location of the JPD
    """ # noqa: E501
    city_name: StrictStr = Field(description="City name")
    country_code: StrictStr = Field(description="Two-letter country code (ISO 3166-1 alpha-2)")
    ...
    __properties: ClassVar[List[str]] = ["city_name", "country_code", "latitude", "longitude"]
