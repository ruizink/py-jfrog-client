...
class ReleaseBundleV2ScanStatusRequest(BaseModel):
    """
    ReleaseBundleV2ScanStatusRequest
    """ # noqa: E501
    name: StrictStr = Field(description="Release bundle name.")
    version: StrictStr = Field(description="Release bundle version.")
    project: Optional[StrictStr] = Field(default=None, description="Project key the release bundle belongs to.")
    __properties: ClassVar[List[str]] = ["name", "version", "project"]
