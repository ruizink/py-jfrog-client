...
class ReportsDateRange(BaseModel):
    """
    Time window (ISO-8601). From product documentation.
    """ # noqa: E501
    start: Optional[StrictStr] = Field(default=None, description="Interval start, e.g. 2020-06-29T12:22:16Z")
    end: Optional[StrictStr] = Field(default=None, description="Interval end, e.g. 2020-06-29T12:22:16Z")
