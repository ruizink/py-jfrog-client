...
class Actions(BaseModel):
    ...
    Actions
    """ # noqa: E501
    users: Optional[Dict[str, List[StrictStr]]] = Field(default=None, description="Map of username to allowed actions")
    groups: Optional[Dict[str, List[StrictStr]]] = Field(default=None, description="Map of group name to allowed actions")
