...
class DeleteOnDemandScanResultsRequest(BaseModel):
    """
    DeleteOnDemandScanResultsRequest
    """ # noqa: E501
    scan_ids: List[StrictStr] = Field(description="List of scan IDs to delete.")
    __properties: ClassVar[List[str]] = ["scan_ids"]
