...
class BuildSummaryArtifactsV2Openapi200ResponseBuild(BaseModel):
    """
    ...
    parent_sha256: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "path", "pkg_type", "sha256", "component_id", "sha1", "parent_sha256"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sha1": obj.get("sha1"),
            "parent_sha256": obj.get("parent_sha256")
        })
        return _obj
