...
class ReportsCveSearchReportRequest(BaseModel):
    """
    Request body for generating a CVE Search Report. The CVE and resources scope are required. Filters are optional. 
    """ # noqa: E501
    cve: StrictStr = Field(description="The CVE identifier to search for (e.g., CVE-2021-45046).")
    name: Optional[StrictStr] = Field(default=None, description="Display name for the report.")
    resources: ReportsResourcesBlock
    filters: Optional[ReportsCveSearchReportRequestFilters] = None
    __properties: ClassVar[List[str]] = ["cve", "name", "resources", "filters"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "filters": ReportsCveSearchReportRequestFilters.from_dict(obj["filters"]) if obj.get("filters") is not None else None
        })
        return _obj
