...
class ArtifactScanStatus200ResponseDetailsExposures(BaseModel):
    """
    ArtifactScanStatus200ResponseDetailsExposures
    """ # noqa: E501
    status: Optional[StrictStr] = None
    time: Optional[StrictStr] = None
    categories: Optional[ArtifactScanStatus200ResponseDetailsExposuresCategories] = None
    __properties: ClassVar[List[str]] = ["status", "time", "categories"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "time": obj.get("time"),
            "categories": ArtifactScanStatus200ResponseDetailsExposuresCategories.from_dict(obj["categories"]) if obj.get("categories") is not None else None
        })
        return _obj
