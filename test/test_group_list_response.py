...
class TestGroupListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GroupListResponse:
        """Test GroupListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupListResponse`
        """
        model = GroupListResponse()
        if include_optional:
            return GroupListResponse(
                groups = [
                    jfrog_client.models.group_record_response.GroupRecordResponse(
                        group_name = '', 
                        uri = '', )
                    ],
                cursor = ''
