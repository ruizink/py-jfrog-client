...
class TestFolderChild(unittest.TestCase):
    """FolderChild unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FolderChild:
        """Test FolderChild
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FolderChild`
        """
        model = FolderChild()
        if include_optional:
            return FolderChild(
