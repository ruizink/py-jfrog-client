...
class TestLicenseBucket(unittest.TestCase):
    """LicenseBucket unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LicenseBucket:
        """Test LicenseBucket
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LicenseBucket`
        """
        model = LicenseBucket()
        if include_optional:
