...
class TestReplicationTarget(unittest.TestCase):
    """ReplicationTarget unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReplicationTarget:
        """Test ReplicationTarget
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReplicationTarget`
        """
    ...
    def testReplicationTarget(self):
        """Test ReplicationTarget"""
