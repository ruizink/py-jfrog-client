...
class TestArchiveMapping(unittest.TestCase):
    """ArchiveMapping unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArchiveMapping:
        """Test ArchiveMapping
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArchiveMapping`
        """
        model = ArchiveMapping()
        if include_optional:
